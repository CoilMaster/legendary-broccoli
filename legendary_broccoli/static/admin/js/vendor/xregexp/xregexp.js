...
// Optional attributes; can be installed and uninstalled
        attributes = {
            natives: false,
            extensibility: false
        },
...
/**
 * Installs optional attributes according to the specified options.
 * @memberOf XRegExp
 ...
 *
 * // Using a shortcut to install all optional attributes
 * XRegExp.install('all');
 */
    self.install = function (options) {
        options = prepareOptions(options);
        if (!attributes.natives && options.natives) {
            setNatives(true);
        }
        if (!attributes.extensibility && options.extensibility) {
            setExtensibility(true);
        }
    };

/**
 * Checks whether an individual optional attribute is installed.
 * @memberOf XRegExp
 * @param {String} attribute Name of the attribute to check. One of:
 *   <li>`natives`
 *   <li>`extensibility`
 * @returns {Boolean} Whether the attribute is installed.
 * @example
 *
 * XRegExp.isInstalled('natives');
 */
    self.isInstalled = function (attribute) {
...
/**
 * Uninstalls optional attributes according to the specified options.
 * @memberOf XRegExp
 * @param {Object|String} options Options object or string.
 * @example
 *
 ...
 *
 * // Using a shortcut to uninstall all optional attributes
